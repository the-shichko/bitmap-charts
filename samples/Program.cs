...
namespace samples
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            chartService.GetChart(ChartMode.LineMode, x => x.Value, x => x.Name)
                .Save(Directory.GetCurrentDirectory() + "\\chartLine.png");
            
            chartService.GetChart(ChartMode.RectangleMode, x => x.Value, x => x.Name)
